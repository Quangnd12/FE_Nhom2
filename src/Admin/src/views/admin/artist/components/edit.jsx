        ...
        <Box overflowX="auto">
          <div className="min-h-screen bg-gray-100 text-black p-6 font-sans">
            <div className="container mx-auto max-w-6xl bg-white rounded-2xl shadow-lg p-8">
              <h1 className="text-2xl font-bold mb-6 text-left">Edit Artist</h1>
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      defaultValue={'Vietnam Pop'}
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 text-left">Personal Info</label>
                    <textarea
                      defaultValue={'Ca sĩ'}
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                    ></textarea>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 text-left">Skill</label>
                    <input
                      type="text"
                      defaultValue={'Sáng tác'}
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 text-left">Musical Instrument</label>
                    <input
                      type="text"
                      defaultValue={'Piano'}
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 text-left">Vocal Ability</label>
                    <input
                      type="text"
                      defaultValue={'Xuất sắc'}
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                    />
                  </div>
                </div>
